...
export interface ContainerTextFlipProps {
  ...
  /** Whether to highlight the text before the last word */
...
export function ContainerTextFlip({
  ...
  const lastSpaceIndex = currentWord.lastIndexOf(" ");
        ...
        <motion.div className="inline-block">
          {words[currentWordIndex].split("").map((letter, index) => (
            <motion.span
              ...
              className={cn(
                highlightPrefix && index < lastSpaceIndex ? "text-primary" : "text-inherit"
              )}
            >
              {letter}
            </motion.span>
